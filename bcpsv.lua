...
--------------------------------------
   ...
   Citizen.CreateThread( function()
      if versionCheckEnabled then 
         ...
         local updatePath = "/Cisco8114/BaitCarPro"
         ...
         function checkVersion(err,response, headers)
            ...
            if not nativeuitest then
               ...
               print("\nhttps://github.com/Cisco8114/NativeUILua")
               print("\n--------------------------------------------------------------------------")
            else
         ...
         function checkVersionHTTPRequest()
            PerformHttpRequest("https://raw.githubusercontent.com/Cisco8114/BaitCarPro/master/version.json", checkVersion, "GET")
         end
